      ...
      <div className="mx-auto w-full container grid  grid-cols-1 md:grid-cols-2">
        ...
        >
          <h1 className="mb-12 text-4xl font-bold">
            Cranberry Delight Toothpaste Refreshing Cranberry Flavor
          </h1>
        ...
        >
          ...
          <div
            ref={q10BubbleRef}
            className="absolute top-1/4 right-[-60px] z-0"
          >
            <Image
          ...
          <div
            ...
            className="absolute  bottom-1/4 right-[-120px] z-0"
          >
            <Image
          ...
          <div ref={hapBubbleRef} className="absolute top-2/3 right-12 z-0">
            <Image
